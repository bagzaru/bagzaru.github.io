...
export class PageNavigation {
  ...
  vertical(direction, { top, max, now, fresh = null }) {
    ...
    // A page that fits on screen needs no inner-scroll waiting period.
    if (max <= 2) return newGesture && this.move(this.index + direction, now) ? 'page' : 'wait';
